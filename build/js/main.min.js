...
window.addEventListener('DOMContentLoaded', function () {
  var ACCORDION_BUTTON_AVAILABLE = document.querySelector('.available .accordion__button');
  var ACCORDION_BUTTON_ABSENCE = document.querySelector('.absence .accordion__button');
  var ACCORDION_ARROW_AVAILABLE = document.querySelector('.available .accordion__arrow');
  var ACCORDION_ARROW_ABSENCE = document.querySelector('.absence .accordion__arrow');
  var BASKET_LIST_AVAILABLE = document.querySelector('.available .basket__list');
  var BASKET_LIST_ABSENCE = document.querySelector('.absence .basket__list');
  ...
  var accordion__checkbox = document.querySelector('.accordion__checkbox input');
  var all_accordion__checkbox = document.querySelectorAll('.product__checkbox input');
  all_accordion__checkbox.forEach(function (check) {
